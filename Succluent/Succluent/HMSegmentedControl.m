...
- (void)drawRect:(CGRect)rect
{
    ...
    [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
        CGFloat stringHeight = [titleString sizeWithFont:self.font].height+10;
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, 0.0+30, stringWidth, self.selectionIndicatorHeight);
    } else {
...
//        [btn setTitleColor:[UIColor colorWithRed:150/255.0 green:150/255.0 blue:150/255.0 alpha:1.0] forState:UIControlStateNormal];
//    }
//    
//    [btn setTitleColor:[UIColor colorWithRed:59/255.0 green:168/255.0 blue:223/255.0 alpha:1.0] forState:UIControlStateNormal];
